/*
  mnist_gpu.cu
  CUDA-accelerated MNIST CNN training

  Usage:
  $ ./mnist_gpu train-images train-labels test-images test-labels
*/
...
int main(int argc, char* argv[])
{
    ...
    fprintf(stderr, "Initializing CUDA CNN layers...\n");
    ...
    fprintf(stderr, "Layers initialized successfully.\n");
    ...
    fprintf(stderr, "Training on GPU...\n");
    double rate = 0.1;
    double etotal = 0;
    int nepoch = 10;
    int batch_size = 32;
    ...
    fprintf(stderr, "Reading test data...\n");
    ...
    fprintf(stderr, "ntests=%d, ncorrect=%d, accuracy=%.2f%%\n", 
            ntests, ncorrect, 100.0 * ncorrect / ntests);
